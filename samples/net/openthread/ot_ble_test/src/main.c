...
static void ot_satate_changed(otChangedFlags flags, struct openthread_context *ot_context,
			      void *user_data)
{
...
int main(void)
{
	...
	static struct openthread_state_changed_cb ot_state_cahnge = {.state_changed_cb =
									     ot_satate_changed};
